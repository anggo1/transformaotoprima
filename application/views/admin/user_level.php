                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="text-right">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="add_level()"
...
$(document).ready(function() {
    ...
    table = $("#tabellevel").DataTable({
        ...
        "serverSide": true,
        "stateSave": true, //Feature control DataTables' server-side processing mode.
        ...
        "columnDefs": [{
            ...
            "render": function(data, type, row) {
                if (row[1] == 1 ) { //|| row[2] > 2
                    ...
                    return "<a class=\"btn btn-xs btn-outline-info\" href=\"javascript:void(0)\" title=\"View\" onclick=\"vlevel(" +
                        ...
                        row[1] +
                        ")\"><i class=\"fas fa-edit\"></i></a><a class=\"btn btn-xs btn-outline-danger\" href=\"javascript:void(0)\" title=\"Delete\" onclick=\"dellevel(" +
                        row[1] + ")\"><i class=\"fas fa-trash\"></i></a>";
                }
            },
            ...
            "targets": [1],
            "render": function(data, type, row) {
                return "<a class=\"btn btn-xs btn-info\" href=\"javascript:void(0)\" title=\"Akses Menu\" onclick=\"aksesmenu(" +
                    row[1] +
                    ")\">Akses Menu</a> <a class=\"btn btn-xs btn-success\" href=\"javascript:void(0)\" title=\"Akses Submenu\" onclick=\"aksessubmenu(" +
                    row[1] + ")\">Akses Submenu</a>";
            }

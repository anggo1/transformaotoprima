            ...
            <div class="card">
              <div class="card-header bg-light">
                ...
                <div class="text-right">
                  <a href="<?php echo base_url("aplikasi/export"); ?>" type="button" class="btn btn-sm btn-outline-info"  title="Download" target="_blank"><i class="fas fa-download"></i> Download1</a>
    ...
    table =$("#tabelsubmenu").DataTable({
        ...
        { 
            ...
            "render": function ( data, type, row ) {
                 ...
                 return "<a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit_aplikasi("+row[10]+")\"><i class=\"fas fa-edit\"></i></a>";
        ...
        },
        {
          ...
          "render": function(data , type , row){
            if (row[9]!=null) {
            return "<img class=\"myImgx\"  src='<?php echo base_url("assets/foto/logo/");?>"+row[9]+"' width=\"100px\" height=\"100px\">";
            }else{

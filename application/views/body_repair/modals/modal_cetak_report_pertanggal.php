                    ...
                    <tr>
                      <th colspan="4"><div align="left">
                        <table width="100%">
                          <tbody>
                            <tr>
                              <td width="100%"><font size="+2">Laporan Pekerjaan Body Repair Per Tanggal</font> </td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                            </tr>
    ...
    <div class="table-responsive">
                    <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000" class="datatable"  id="table-1" >
                                            ...
                                            ?> <tr>
                                                    ...
                                                    <td><?php echo $s->jml_pk; ?></td>
                                                    <td><?php echo $s->nama_kategori; ?></td>
                                                    <td><?php echo $s->ket_lapor; ?></td>
                                                    <td><?php if($s->status=="Y") {echo "Proses";}if($s->status=="P") {echo "Pending";}if($s->status=="S") {echo "Selesai";} ?></td>
                                                </tr>
                                            <?php
                                                $no++;
                                            }

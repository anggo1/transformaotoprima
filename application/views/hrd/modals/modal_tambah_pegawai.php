<div class="col-12 col-md-12 col-lg-12">
  <div class="modal-header">
    ...
    <h4 style="display:block; text-align:center;"><?php if (!empty($dataDepartement->id_departement)) {
                                                    ...
                                                    echo 'Penambahan Data Departement';
                                                  }
                                                  ?></h4>
    </p>
  </div>
  <div class="modal-body">
    <form <?php if (empty($dataDepartement->id_departement)) {
            echo 'id="form-tambah-departement"';
          } else {
            echo 'id="form-update-departement"';
          } ?> method="POST">
      <div class="form-group">
        <input type="hidden" name="id_departement" value="<?php if (!empty($dataDepartement->id_departement)) {
                                                            echo $dataDepartement->id_departement;
                                                          } ?>">
      </div>
      ...
      <div class="modal-footer bg-whitesmoke br">
        ...
        <button type="submit" class="btn btn-primary" onclick="save()"><i class="fa fa-save"></i> Save changes</button>
      </div>
    </form>
  </div>
</div>

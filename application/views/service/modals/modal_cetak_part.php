                    ...
                    <table width="100%" border="0" cellpadding="1" style="font-size: 14px;" cellspacing="0"
                        ...
                        <thead>
                            <tr>
                                <th colspan="3">
                                    <div align="left">
                                        <font size="2">Part Requuest Form</font>
                                    </div>
                                </th>
                            ...
                            <tr>
                                ...
                                <th width="113">&nbsp;</th>
                                <th width="193">
                                    <div align="left">Workshop order no</div>
                                </th>
                                <th width="350">
                                    <div align="left">: <?php echo $s->wo_no ?></div>
                                </th>
                            </tr>
                            <tr>
                                <th>&nbsp;</th>
                                ...
                                <th rowspan="2">
                                    <div align="left">: <?php echo $c->alamat ?>, <?php echo $c->kota ?></div>
                                    <div align="left"></div>
                                </th>
                                <th>
                                    <div align="left">VIN</div>
                                </th>
                                <th><span class="text2"><?php echo $s->vin ?></span></th>
                                <th>
                                    <div align="left">Oredered by</div>
                                </th>
                                <th>
                                    <div align="left">: <?php echo $c->nama_cus; ?></div>
                                </th>
                            ...
                            <tr>
                                <th height="20">&nbsp;</th>
                                <th height="20">
                                    <div align="left">Car Registration no</div>
                                </th>
                                <th height="20">
                                    <div align="left">: <?php echo $s->no_pol ?></div>
                                </th>
                                <th>
                                    <div align="left"></div>
                                </th>
                                <th>&nbsp;</th>
                                <th>
                                    <div align="left">Issued on</div>
                                </th>
                                <th>
                                    <div align="left">: <?php echo $s->customer_complain; ?> ( Jenis Service )</div>
                                </th>
                            </tr>
                            <tr>
                                <th height="20">&nbsp;</th>
        ...
        foreach ($dataPart as $d) { 
          ...
          ?>
                            <tr>
                                ...
                                <td>
                                    <div align="center"><?php echo $d->no_part; ?>&nbsp;</div>
                                </td>
                                <td>&nbsp;</td>
                                <td width="4%">
                                ...
                                <td width="28%">
                                    <div align="center"><?php echo $d->nama_part; ?>&nbsp;</div>
                                </td>
                                <td width="11%">
                                    <div align="center"><?php echo number_format($d->harga, 0, ',', '.'); ?>&nbsp;</div>
                                </td>
                                <td width="9%">
                                    <div align="center">
                                ...
                                <td width="12%">
                                    <div align="center">
                                        <?php echo 'Rp. '.number_format($total_dengan_ppn, 0, ',', '.'); ?>&nbsp;</div>
                                </td>
                            </tr>

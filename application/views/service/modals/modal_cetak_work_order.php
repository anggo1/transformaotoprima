          ...
          <table width="100%" border="0" cellpadding="1" style="font-size: 14px;" cellspacing="0" class="datatable1">
            <thead>
              <tr>
                <th colspan="2">
                  <div align="left">
                    <font size="2">Work Order Form</font>
                  </div>
                </th>
                <th>&nbsp;</th>
                <th>
          ...
          <table width="100%" border="1" cellpadding="1" cellspacing="0" class="datatable2">
            ...
            <tr>
              ...
              <th>
                ...
                <div class="text2"><?php echo $s->engine_no ?></div>
              </th>
              <th>
                <div class="text1">
                  <font size="-2">Active reception</font>
                </div>
                <div class="text2 row"><div class="kotak-timbul"></div> &nbsp;&nbsp; Yes &nbsp;&nbsp;<div class="kotak-timbul"></div>&nbsp;&nbsp; No </div>
              </th>
              <th>
                <div class="text1">
            ...
            <tr>
              ...
              <th>
                <div class="text1">
                  <font size="-2">Date line/time</font>
                </div>

                <div class="text2"><?php echo tglIndoSedang($s->dead_line) . '/' . $s->dead_time ?></div>
              </th>
            </tr>
          </table>
            ...
            <thead>
              ...
              ?>
                  <tr>
                    ...
                    <td width="8%">
                      <div align="center"><?php echo $d->jumlah; ?></div>
                    </td>

<div class="col-12 col-md-12 col-lg-12">
    ...
    <div class="modal-body form">
        ...
        <form <?php if (empty($dataCus->id_cus)) {
            ...
            <div class="form-group">
                <label class="control-label">Nama Singkat Customer <span class="required red"> *</span></label>
                <input type="text" class="form-control" placeholder="Nama Customer" value="<?php
                                                                                    if (!empty($dataCus->kode_nama)) {
                                                                                      echo $dataCus->kode_nama;
                                                                                    }
                                                                                    ?>" name="kode_nama"
                    aria-describedby="sizing-addon2" require>
            </div>
            <div class="form-group">
                <label class="control-label">Nama Customer <span class="required red"> *</span></label>
                <input type="text" class="form-control" placeholder="Nama Customer" value="<?php
            ...
            <div class="form-group">
                <label class="control-label">Detail Customer</label>
                <input type="text" class="form-control" placeholder="Detail Customer" value="<?php
                                                                                    if (!empty($dataCus->detail)) {
                                                                                      echo $dataCus->detail;
                                                                                    }
                                                                                    ?>" name="detail"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Kota" value="<?php
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="No Fax Customer" value="<?php
                                                                                      if (!empty($dataCus->no_fax)) {
                                                                                        echo $dataCus->no_fax;
                                                                                      }
                                                                                      ?>" name="no_fax"
                    aria-describedby="sizing-addon2">

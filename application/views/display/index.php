...
<div class="header" align="center">
    ...
    <div class="denah">
        ...
        <div class="jarak_mobil"></div>
          <div class="bis2">
              <div class="isikategori2">
                ...
                id-bay="1" id-lapor="<?php echo $by1->id_lapor; ?>">
                  <?php echo '<font size=3>'.$by1->no_body.'</strong></font>'; ?><br>
                  ...
                  <p>
                    <?php 
                    $diff  = date_diff( date_create($by1->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by1->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari')
                    
                   // $tgl1 = new DateTime($by1->tgl_masuk);$jarak = $kini->diff($tgl1);echo 'BM : '. $jarak->d. '%m Hari'?>
                  </p>
                </button>
          ...
          <div class="bis2">
              <div class="isikategori2">
                ...
                <button <?php if($by2->status=='P'){echo 'class="tombolbus_pause check"';}if($by2->status=='Y'){ echo 'class="tombolbus check"';}  ?> id-bay="2" id-lapor="<?php echo $by2->id_lapor; ?>">
                  <?php echo '<font size=3>'.$by2->no_body.'</strong></font>'; ?><br>
                  ...
                  <p>
                    <?php 
                    $diff  = date_diff( date_create($by2->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by2->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?>
                  </p>
                </button>
                <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by3->status=='P'){echo 'class="tombolbus_pause check"';}if($by3->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="3" id-lapor="<?php echo $by3->id_lapor; ?>">
                <?php echo '<font size=3>'.$by3->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php
                    $diff  = date_diff( date_create($by3->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by3->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');
                    ?>
                </p>
              </button>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by4->status=='P'){echo 'class="tombolbus_pause check"';}if($by4->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="4" id-lapor="<?php echo $by4->id_lapor; ?>">
                <?php echo '<font size=3>'.$by4->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by4->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by4->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');
                    ?>
                </p>
              </button>
          ...
          <div class="jarak_mobil"></div>
            <div class="bisantri">
                    <div class="isikategoriantri">
                        <div class="antri">ANTRI CAT  <br><?php 
                        foreach ($totalCat as $acat){  echo "<font color=black> Total :".$acat->total_cat."</font>";}?></div>
                        <ul id="ticker_06" class="ticker_antri">
                  <?php 
                        foreach ($antriCat as $cat){  ?>
                        <?php
                            echo "<li>
                    <table width=100%>	
                    <td><div align=center><font size=2+><strong>".$cat->no_body."</strong></font></div></td></table></li>";
            }
                        ?>
                </ul>
          </div>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by5->status=='P'){echo 'class="tombolbus_pause check"';}if($by5->status=='Y'&&$by5->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="5" id-lapor="<?php echo $by5->id_lapor; ?>">
                <?php echo '<font size=3>'.$by5->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by5->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by5->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');
                    ?>
                </p>
              </button>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by6->status=='P'){echo 'class="tombolbus_pause check"';}if($by6->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="6" id-lapor="<?php echo $by6->id_lapor; ?>">
                <?php echo '<font size=3>'.$by6->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by6->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by6->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');
                    ?>
                </p>
              </button>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by7->status=='P'){echo 'class="tombolbus_pause check"';}if($by7->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="7" id-lapor="<?php echo $by7->id_lapor; ?>">
                <?php echo '<font size=3>'.$by7->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by7->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by7->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');
                    ?>
                </p>
              </button>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by8->status=='P'){echo 'class="tombolbus_pause check"';}if($by8->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="8" id-lapor="<?php echo $by8->id_lapor; ?>">
                <?php echo '<font size=3>'.$by8->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by8->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by8->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');
                    ?>
                </p>
              </button>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by9->status=='P'){echo 'class="tombolbus_pause check"';}if($by9->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="9" id-lapor="<?php echo $by9->id_lapor; ?>">
                <?php echo '<font size=3>'.$by9->no_body.'</strong></font>'; ?><br>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by10->status=='P'){echo 'class="tombolbus_pause check"';}if($by10->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="10" id-lapor="<?php echo $by10->id_lapor; ?>">
                <?php echo '<font size=3>'.$by10->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by10->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by10->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?>
                </p>
              </button>
              <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by11->status=='P'){echo 'class="tombolbus_pause check"';}if($by11->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="11" id-lapor="<?php echo $by11->id_lapor; ?>">
                <?php echo '<font size=3>'.$by11->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by11->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by11->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?>
                </p>
              </button>
              <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by12->status=='P'){echo 'class="tombolbus_pause check"';}if($by12->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="12" id-lapor="<?php echo $by12->id_lapor; ?>">
                <?php echo '<font size=3>'.$by12->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by12->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by12->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?>
                </p>
              </button>
              <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by13->status=='P'){echo 'class="tombolbus_pause check"';}if($by13->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="13" id-lapor="<?php echo $by13->id_lapor; ?>">
                <?php echo '<font size=3>'.$by13->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by13->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by13->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?>
                </p>
              </button>
              <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
          ...
          <div class="bis2">
            <div class="isikategori2">
              ...
              <button <?php if($by14->status=='P'){echo 'class="tombolbus_pause check"';}if($by14->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="14" id-lapor="<?php echo $by14->id_lapor; ?>">
                <?php echo '<font size=3>'.$by14->no_body.'</strong></font>'; ?><br>
                ...
                <p>
                  <?php 
                    $diff  = date_diff( date_create($by14->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by14->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?>
                </p>
              </button>
              <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
        ...
        <div class="jarak_mobil4"></div>
              ...
              <div class="bisantri">
                <div class="isikategoriantri">
                        <div class="antri">ANTRI TRM <br><?php 
                        foreach ($totalTriming as $tm){  echo "<font color=black> Total :".$tm->total_triming."</font>";}?></div>
                        
                        <ul id="ticker_07" class="ticker_antri">
                  <?php 
                        foreach ($antriTriming as $tr){  ?>
                        <?php
                            echo "<li>
                    <table width=100%>	
                    <td><div align=center><font size=2+><strong>".$tr->no_body."</strong></font></div></td></table></li>";
            }
                        ?>
                </ul>
                    </div>
              ...
              <div class="bis2">
                <div class="isikategori2">
                        ...
                        <button <?php if($by15->status=='P'){echo 'class="tombolbus_pause check"';}if($by15->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="15" id-lapor="<?php echo $by15->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by15->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by15->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by15->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by16->status=='P'){echo 'class="tombolbus_pause check"';}if($by16->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="16" id-lapor="<?php echo $by16->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by16->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by16->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by16->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by17->status=='P'){echo 'class="tombolbus_pause check"';}if($by17->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="17" id-lapor="<?php echo $by17->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by17->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by17->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by17->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by18->status=='P'){echo 'class="tombolbus_pause check"';}if($by18->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="18" id-lapor="<?php echo $by18->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by18->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by18->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by18->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="bisantri">
                <div class="isikategoriantri">
                        <div class="antri">ANTRI ELK <br><?php 
                        foreach ($totalElektrik as $el){  echo "<font color=black> Total :".$el->total_elektrik."</font>";}?></div>
                        <ul id="ticker_08" class="ticker_antri">
                  <?php 
                        foreach ($antriElektrik as $el){  ?>
                        <?php
                            echo "<li>
                    <table width=100%>	
                    <td><div align=center><font size=2+><strong>".$el->no_body."</strong></font></div></td></table></li>";
            }
                        ?>
                </ul>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by19->status=='P'){echo 'class="tombolbus_pause check"';}if($by19->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="19" id-lapor="<?php echo $by19->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by19->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by19->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by19->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by20->status=='P'){echo 'class="tombolbus_pause check"';}if($by20->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="20" id-lapor="<?php echo $by20->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by20->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by20->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by20->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by21->status=='P'){echo 'class="tombolbus_pause check"';}if($by21->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="21" id-lapor="<?php echo $by21->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by21->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by21->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by21->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
        ...
        <div class="jarak_mobil3"></div>
                <div class="bis5">
                    ...
                    <div class="jarak_mobil2"></div>
                    <div class="judul">
                        <strong>PEKERJAAN HARIAN</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="jarak_mobil2"></div>
              ...
              <div class="bisantri">
                <div class="isikategoriantri">
                        <div class="antri">ANTRI QC <br><?php 
                        foreach ($totalQc as $qt){  echo "<font color=black> Total :".$qt->total_qc."</font>";}?></div>
                <ul id="ticker_09" class="ticker_antri">
                  <?php 
                        foreach ($antriQc as $qc){ ?>
                        <?php
                            echo "<li>
                    <table width=100%>	
                    <td><div align=center><font size=2+><strong>".$qc->no_body."</strong></font></div></td></table></li>";
            }
                        ?>
                </ul>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by22->status=='P'){echo 'class="tombolbus_pause check"';}if($by22->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="22" id-lapor="<?php echo $by22->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by22->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by22->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by22->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by23->status=='P'){echo 'class="tombolbus_pause check"';}if($by23->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="23" id-lapor="<?php echo $by23->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by23->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by23->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by23->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
        ...
        <div class="jarak_mobil"></div>
              ...
              <div class="bisantri">
                <div class="isikategoriantri">
                        <div class="antri">ANTRI JOK <br><?php 
                        foreach ($totalJok as $jk){  echo "<font color=black> Total :".$jk->total_jok."</font>";}?></div>
                       
    <ul id="ticker_10" class="ticker_antri">
      <?php 
						foreach ($antriJok as $jk){
                echo "<li>
				<table width=100%>	
				<td><div align=center><font size=2+><strong>".$jk->no_body."</strong></font></div></td></table></li>";
}
            ?>
    </ul>
                    </div>
        ...
        <div class="jarak_bus"></div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by24->status=='P'){echo 'class="tombolbus_pause check"';}if($by24->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="24" id-lapor="<?php echo $by24->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by24->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by24->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by24->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by25->status=='P'){echo 'class="tombolbus_pause check"';}if($by25->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="25" id-lapor="<?php echo $by25->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by25->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by25->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by25->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
        ...
        <div class="bisantri">
          <div class="isikategoriantri">
                  <div class="antri">ANTRI PH <br><?php 
                        foreach ($totalPh as $pl){  echo "<font color=black> Total :".$pl->total_ph."</font>";}?></div>
                       
                       <ul id="ticker_11" class="ticker_antri">
                         <?php 
                               foreach ($antriPh as $ph){
                                   echo "<li>
                           <table width=100%>	
                           <td><div align=center><font size=2+><strong>".$ph->no_body."</strong></font></div></td></table></li>";
                   }
                               ?>
                       </ul>
              </div>
        ...
        <div class="jarak_bus"></div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by26->status=='P'){echo 'class="tombolbus_pause check"';}if($by26->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="26" id-lapor="<?php echo $by26->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by26->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by26->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by26->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by27->status=='P'){echo 'class="tombolbus_pause check"';}if($by27->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="27" id-lapor="<?php echo $by27->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by27->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by27->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by27->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by28->status=='P'){echo 'class="tombolbus_pause check"';}if($by28->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="28" id-lapor="<?php echo $by28->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by28->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by28->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by28->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari').'<br>';?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by29->status=='P'){echo 'class="tombolbus_pause check"';}if($by29->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="29" id-lapor="<?php echo $by29->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by29->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by29->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by29->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
                ...
                <div class="isikategori2">
                        ...
                        <button <?php if($by30->status=='P'){echo 'class="tombolbus_pause check"';}if($by30->status=='Y'){echo 'class="tombolbus check"';}  ?> id-bay="30" id-lapor="<?php echo $by30->id_lapor; ?>">
                            <?php echo '<font size=3>'.$by30->no_body.'</strong></font>'; ?><br>
                            PK :
                            ...
                            <p><?php 
                    $diff  = date_diff( date_create($by30->tgl_masuk), date_create() );
                    echo $diff->format('BM : %a hari').'<br>';
                    $diff  = date_diff( date_create($by30->tgl_mulai), date_create() );
                    echo $diff->format('PM : %a hari');?></p>
                        </button>
                    <?php } else { echo '<div class="empty">EMPTY</div>';} ?>
                    </div>
    ...
    <table width="50%" align="center" border="0">
        <tbody>
            <tr>
                ...
                <th width="15%" style="font-size:12px; text-align:left;">
                ...
                <th width="15%" style="font-size:12px; text-align:left;">BM<span style="font-size:12px;text-align:left;">: Bis Masuk</span></th>
                <th width="15%" style="font-size:12px; text-align:left;">PM<span style="font-size:12px;text-align:left;">: PK Mulai</span></th>
            </tr>
        </tbody>
    </table>
    ...
    <ul id="ticker_02" class="ticker">
        <div align="center">
            <table width="100%">
                <td width="100%" class="keterangan_lanjutan">
                    <strong>ANTRIAN PERBAIKAN BUS (TOTAL <?php foreach($totalAntri as $a){ } echo $a->tAntri ?> BODY)</strong>
                </td>
            </table>
        </div>
        <div align="left">
        ...
        <li>
            ...
            foreach($dataAntri as $antri){
				...
				<td width=25%% class=isi_slider ><div align=center> ".tglIndoSedang($antri->tgl_masuk)."</div> </td>
...
<div id="page2">
    <ul id="ticker_03" class="ticker">
        <div align="center">
            <table width="100%">
                <td width="100%" class="keterangan_lanjutan">
                    <strong>WIP (WORK IN PROCESS)  (TOTAL <?php foreach($totalPk as $p){ } echo $p->total; ?> SPK)</strong>
                </td>
            </table>
        </div>
        <div align="left">
        ...
        <li>
            ...
            foreach($listPk as $pk){
				...
				<td width=20% class=isi_slider ><div align=center> ".$pk->jml_pk."</div></td>
...
<div id="page3">
    <ul id="ticker_04" class="ticker">
        <div align="center">
            <table width="100%">
                <td width="100%" class="keterangan_lanjutan">
                    <strong>DAFTAR KENDARAAN SIAP KELUAR (TOTAL <?php foreach($totalKeluar as $k){ } echo $k->tKeluar; ?> BODY)</strong>
                </td>
            </table>
        </div>
        <div align="left">
...
<script type="text/javascript">
  ...
  function tick1() {
    ...
    function tick7() {
        $('#ticker_07 li:first').slideUp(function () {
            $(this)
                .appendTo($('#ticker_07'))
                .slideDown();
        });
    ...
    function tick8() {
        $('#ticker_08 li:first').slideUp(function () {
            $(this)
                .appendTo($('#ticker_08'))
                .slideDown();
        });
    ...
    function tick9() {
        $('#ticker_09 li:first').slideUp(function () {
            $(this)
                .appendTo($('#ticker_09'))
                .slideDown();
        });
    ...
    function tick10() {
        $('#ticker_10 li:first').slideUp(function () {
            $(this)
                .appendTo($('#ticker_10'))
                .slideDown();
        });
    ...
    function tick11() {
        $('#ticker_11 li:first').slideUp(function () {
            $(this)
                .appendTo($('#ticker_11'))
                .slideDown();
        });

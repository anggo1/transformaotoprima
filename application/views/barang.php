        ...
        "ajax": {
         ...
         { 
            ...
            "render": function ( data, type, row ) {
            	...
            	return "<a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit_brg("+row[5]+")\"><i class=\"fas fa-edit\"></i></a><a class=\"btn btn-xs btn-outline-danger\" href=\"javascript:void(0)\" title=\"Delete\" nama="+row[0]+"  onclick=\"delbrg("+row[5]+")\"><i class=\"fas fa-trash\"></i></a>";
...
function edit_brg(no_bahan){
    ...
    $.ajax({
    	url : "<?php echo site_url('barang/edit_barang')?>/" + no_bahan,
    	type: "GET",
    	dataType: "JSON",
    	success: function(data)
    	{

    		$('[name="no_bahan"]').val(data.no_bahan);
		...
		<div class="modal-content ">
			...
			<div class="modal-body form">
				<form action="#" id="form" class="form-horizontal" >
					<input type="hidden" value="" name="no_bahan"/> 
					<div class="card-body">

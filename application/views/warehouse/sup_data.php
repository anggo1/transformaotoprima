       ...
       <tr>
           ...
           <td class="text-center">
               ...
               <button class="btn btn-sm btn-outline-danger delete-supplier ion-android-delete" data-toggle="modal"
                   data-target="#hapusSupplier" data-id="<?php echo $s->id_supplier; ?>"></button>
           </td>
       </tr>
       <?php
          $no++;

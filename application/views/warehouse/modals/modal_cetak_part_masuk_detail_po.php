        ...
        <div class="card-body">
            <div class="col-12 ">
                ...
                <div class="table-responsive">
                    <table class="table display compact" width="100%" id="list-cetak-detail">
                        <thead>
                            <tr>
                                <th width='5%'>No</th>
                                <th>No Ref</th>
...
$(document).ready(function() {
    var table = $('#list-cetak-detail').dataTable({
    "paging": false,
        "lengthChange": false,
        "searching": false,
        "ordering": true,
        ...
        $(api.column(12).footer()).html(total);
            ...
            "rowGroup": {
                ...
                "endRender": function(rows, group, type) {
                    ...
                    return $('<tr/>')
                        .append(
                            '<td colspan="12" style=font-weight: bolder; align="right">TOTAL</td>')
            ...
            processColumnNodes($('#list-cetak-detail').DataTable());
        }
    });

...
<div class="card-footer justify-content-between">
    ...
    <button class="btn btn-danger" id="tutup" data-dismiss="modal"><span class="fa fa-close"></span>&nbsp;&nbsp; T U T U P</button>
        ...
        <div class="card-body">
            <div class="col-12 ">
<div id="printThis">
                <H4>Report Detail Barang Keluar Dengan PK</H4>
                <div class="table-responsive">
                    <table class="table table-bordered" width="100%" id="list-data_detail">
                        <thead>
                        <tr>
                                <th>No</th>
                                <th>No Ref</th>
...
$(document).ready( function () {
        var table = $('#list-data_detail').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                processColumnNodes($('#list-data_detail').DataTable());
            }
        });

                        ...
                        <section class="content">
                            <div class="container-fluid">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <select name="kelompok" class="form-control">
                                                            ...
                                                            <option value="<?php echo $kel->kelompok; ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <select name="kategori" class="form-control">
                                                            ...
                                                            <option value="<?php echo $tk->kategori; ?>"
                                    ...
                                    <div class="col-sm-4">
                                        <select name="supplier" class="form-control">
                                            ...
                                            <?php
                                                            ...
                                                            ?>
                                            <option <?php echo $sp == $sp->kode_nama ? 'selected="selected"' : '' ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="harga_pricelist" id="harga_pricelist"
                                            onkeyup="formatNumber(this)" onchange="formatNumber(this);"
                                            onclick="formatNumber(this);" value="<?php if (!empty($part->hrg_pricelist)) {
                                                          echo $part->hrg_pricelist;
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="harga_net" id="harga_net"
                                            onkeyup="formatNumber(this)" onchange="formatNumber(this);"
                                            onclick="formatNumber(this);" value="<?php if (!empty($part->harga_net)) {
                                                          echo $part->harga_net;
                                                        }else{ echo '0';} ?>" class="form-control">
                                    </div>
                                </div>

...
<div class="modal-body">
  ...
  <thead>
      <tr>
        <th style="text-align: center;"><h4>BARANG MASUK NON PO</h4></th>
      </tr>
    </thead>
  ...
  <thead>
      <tr>
        <th width="298" align="left"><?php  echo $apl->nama_owner; ?></th>
        <th width="105">Kode</th>
        <th width="178">: <?php echo $k->id_masuk; ?></th>
        <th width="117">Kode Supplier</th>
        <th width="204">: <?php echo $k->kode_sup; ?></th>
      </tr>
      <tr>
  ...
  <table>
    ...
    <thead>
        <tr>
          ...
          <th width="20%" rowspan="2" style="text-align: center;">Kode</th>
          <th width="30%" rowspan="2">Nama Barang</th>
          <th width="10%" rowspan="2" style="text-align: center;">Satuan</th>
          ...
          <tr>
            <th width="5%" align="center" style="text-align: center;">Awal</th>
            <th width="5%" align="center" style="text-align: center;">Masuk</th>
            <th width="5%" align="center" style="text-align: center;">Akhir</th>
          </tr>
        <?php
        $no = 0;
        $total = 0;

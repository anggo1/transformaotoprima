...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="datatable2">
    <thead>
      ...
      <tr align="center" >
        <th colspan="2"><h4>CV PART ORDER</h4></th>
      </tr>
    </thead>
  ...
  <table width="100%" border="0" cellpadding="5" style="font-size: 14px;" cellspacing="0" class="datatable1">
    <thead>
      ...
      <tr>
        <th height="32" colspan="2"><div align="left">FAX : <?php echo $k->no_fax ?></div></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
      </tr>
      <tr>
        <th height="32" colspan="2">&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
      </tr>
      <tr>
        <th height="32" colspan="2"><div align="left">From</div></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
      </tr>
      <tr>
        <th width="101" height="32"><div align="left"><strong>Dealer Name</strong></div></th>
      ...
      <tr>
        <th height="32"><div align="left"><strong>Order No</strong></div></th>
        <th height="32"><div align="left">: <?php echo $k->kode_pesan; ?></div></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
      </tr>
    ...
    <table width="100%" border="1" cellpadding="3" cellspacing="0" class="datatable2">
      <thead>
        <tr>
          ...
          <th width="26%" rowspan="2">Description</th>
          <th width="3%" rowspan="2">Qty</th>
          <th width="3%" rowspan="2"><p>BO Y/N</p></th>
          <th width="23%" rowspan="2">Remark</th>
        </tr>
        <tr>
          <th width="3%">SC</th>
          <th width="31%">&nbsp;</th>

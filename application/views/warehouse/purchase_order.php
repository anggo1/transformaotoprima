	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="card card-default">
					...
					<div class="modal-content">
						<div class="modal-header text-blue">
							...
							<button type="button" class="btn btn-success" id="tambah" hidden="hidden" onclick="window.location.reload();" title="Add Data"><i class="fas fa-plus"></i> PO BARU</button>
						</div>
						<div class="modal-body">
							...
							<form id="formPo" name="formPo" method="POST">
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" name="top" id="top" value="" class="form-control" placeholder="Term of Payment">
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-sm-3">
										<input type="number" name="ppn" id="ppn" value="0" class="form-control" onKeyDown="fn(this)" onKeyPress="fn(this)" placeholder="Pajak Pertambahan Nilai">
									</div>
						...
						?>
						<input type="hidden" name="id_po" id="id_po" value="<?php echo $kode_po ?>" class="form-control">
						...
						<div class="modal-footer right-content-between">
							<button class="btn btn-primary" id="simpan" type="submit"><span class="fa fa-save"></span> Simpan Data</button>
							<button type="button" class="btn btn-info cetak-po" id="cetak" hidden="hidden" data-id="" title="Add Data"><i class="fas fa-print"></i> Cetak PO</button>
						</div>
						</form>
						</div>
								<div class="card-body">
			...
			<div id="data-po-cache"></div>
							<button type="button" class="btn btn-xl bg-gradient-success" id="tambah-part" title="Add Part" data-toggle="modal" data-target="#modal_form"><i class="fas fa-plus"></i> Tambah Barang PO</button>
				</div>
					</div>
...
<script type="text/javascript">
	function fn(o){o.value=o.value.toUpperCase().replace(/([^0-9(),-/])/g, '');}

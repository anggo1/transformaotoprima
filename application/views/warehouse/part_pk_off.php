            ...
            <div class="card">
                ...
                <div class="modal-content">
                    ...
                    <div class="card-header card-blue card-outline">
                        ...
                        <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Penambahan Barang
                            Pekerjaan Yang Telah Selesai</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 col-form-label">Masukan No SPK Jika tidak ada di List (Status
                                Keluar)</label>
                            <div class="input-group form-group">
                                <div class="input-group col-sm-2" id="reservationdate" data-target-input="nearest">
                                    <input type="text" name="id_lapor" id="id_lapor" placeholder="Nomor SPK"
                                        class="form-control">
                                </div>
                                <button class="btn bg-gradient-primary col-sm-1" onclick="tampilPk()"
...
?>
    ...
    function refresh() {
        ...
        MyTable = $('#list-pkaktif2,#list-detail').DataTable();

    }

    var MyTable = $('#list-pkaktif2,#list-Detail').dataTable();
    ...
    function tampilPk() {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo base_url('PartPkOff/showPk'); ?>?id_lapor=' +
                id_lapor,
    ...
    $(document).on("click", ".part-pk", function() {
        ...
        $
            ...
            .ajax({
                ...
                url: "<?php echo base_url('PartPkOff/Part'); ?>",
    ...
    $(document).on('submit', '#formKeluar', function(e) {
        ...
        $.ajax({
                ...
                url: '<?php echo base_url('PartPkOff/prosesKeluar'); ?>',
    ...
    function showDetail() {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('PartPkOff/showDetail'); ?>?id_keluar=' + id_keluar,
    ...
    function isi_otomatis() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('PartPkOff/cariPart') ?>/" + no_part,

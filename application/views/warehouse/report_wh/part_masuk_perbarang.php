            ...
            <div class="card">
                <div class="modal-content">
                    <div class="card-header card-blue card-outline">
                        <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Data Penerimaan Barang</h3>
                    </div>
...
function listPart() {
    ...
    $.ajax({
        type: 'GET',
        url: '<?php echo base_url('ReportWhMasukPerbarang/listPart'); ?>?date1' + date1 + '&date2=' + date2,

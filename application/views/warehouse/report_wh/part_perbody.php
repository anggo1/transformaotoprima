                        ...
                        <div class="card">
                            <div class="modal-content">
                                <div class="card-header card-blue card-outline">
                                    <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Data Penggunaan Barang Per Body</h3>
                                </div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-2">
										<div class="input-group date" id="reservationdate" data-target-input="nearest">
											...
											<input type="text" name="no_body" id="no_body" class="form-control" required>
...
<script type="text/javascript">
    ...
    function listBody() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportWhPerbody/listBody'); ?>?date1'+date1+'&date2=' +date2,
		data: 'date1=' +date1+'&date2=' +date2+'&no_body=' +no_body,
			success:
            function(hasil) {
			MyTable.fnDestroy();

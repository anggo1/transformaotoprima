        ...
        <div class="content">
                        <div class="card">
                            <div class="modal-content">
                                <div class="card-header card-blue card-outline">
                                    <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Data Barang Return / Repair</h3>
                                </div>
                    ...
                    <div class="card-body">
								...
								<div class="form-group row">
									<label class="col-sm-1 col-form-label">Status Part</label>
									<div class="col-sm-3">
									...
									<div class="col-sm-1">
							<button class="btn bg-gradient-primary col-sm-12" onclick="listReturn()" type="submit"><span class="fa fa-search"></span> Cari</button>
								</div>
						</div>
                                    <div id="data-return">
                                <div id="modal-po"></div>
...
<script type="text/javascript">
    ...
    function listReturn() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportWhReturn/listReturn'); ?>?date1'+date1+'&date2=' +date2,
		data: 'date1=' +date1+'&date2=' +date2+'&status=' +status,
			success:
            function(hasil) {
			MyTable.fnDestroy();
			$('#data-return').html(hasil);
			refresh();
			}
		});
	}

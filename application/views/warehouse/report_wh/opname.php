...
<script type="text/javascript">
	...
	function listOpnameDetail() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportOpname/detailOpname'); ?>?date1'+date1+'&date2=' +date2,
    ...
    function listOpname() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportOpname/listOpname'); ?>?date1'+date1+'&date2=' +date2,
		data: 'date1=' +date1+'&date2=' +date2,
			success:
            function(hasil) {
			MyTable.fnDestroy();
	...
	function cetaklistOpnameDetail() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportOpname/cetak_detailOpname'); ?>?date1'+date1+'&date2=' +date2,
		data: 'date1=' +date1+'&date2=' +date2,
	...
	function listViewOpname() {
		var date1 = document.getElementById("tgl_awal").value;
		var date2 = document.getElementById("tgl_akhir").value;
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportOpname/view_detailOpname'); ?>?date1'+date1+'&date2=' +date2,
		data: 'date1=' +date1+'&date2=' +date2,
        success: function(hasil) {
                $('#modal-cetak-detail').html(hasil);
                $('#cetak-masuk-detail').modal('show');
...
$(document).on("click", ".delete-opname", function() {
	...
	$(document).on("click", ".hapus-opname", function() {
		...
		$.ajax({
				method: "POST",
				url: "<?php echo base_url('ReportOpname/deleteOpname'); ?>",
				data: "id=" + id
			})
			.done(function(data) {

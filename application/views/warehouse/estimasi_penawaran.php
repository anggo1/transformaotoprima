                    ...
                    <div class="modal-content">
                        <div class="modal-header text-blue">
                            ...
                            <h5 style="display:block; text-align:center;"><span
                                    class="ion-soup-can-outline ion-lg text-blue"></span>&nbsp; Estimasi Penawaran</h5>
                            <button type="button" class="btn btn-success" id="tambah" hidden="hidden"
                                onclick="window.location.reload();" title="Add Data"><i class="fas fa-plus"></i>
                                Estimasi
                                Baru</button>
                        </div>
                        <div class="modal-body">
                            ...
                            <form id="formPo" name="formPo" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <label class="col-form-label">Dat of 1st registration</label>
                                        <input type="text" name="keterangan" id="keterangan" value=""
                                            class="form-control" placeholder="Keterangan">
                                    </div>
                                    <div class="col-3">
...
$('#tgl_estimasi_penawaran,#tgl_awal,#tgl_akhir').datetimepicker({
    format: 'DD-MM-YYYY',
    date: moment()
});

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/datepicker-bs4/css/bootstrap-datepicker3.css">
    <!-- summernote -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/print/print.min.css">
...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-footer-fixed sidebar-collapse sidebar-nav-flat-style">
    <div class="wrapper">
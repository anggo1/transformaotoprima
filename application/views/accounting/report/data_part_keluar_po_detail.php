            ...
            <div class="col-12 ">
                <div class="table-responsive">
                    <table width="100%" class="table table-bordered table-hover nowrap" id="list-part">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>No SPK</th>
    ...
    $(document).ready(function() {
        var table = $('#list-part').DataTable({
            ...
            "buttons": [
                ...
                //  },
                {
                    ...
                    className: 'btn btn-sm btn-outline-primary list-pk',
                    init: function(api, node, config) {
                        $(node).removeClass('btn-secondary')
                    }
                },
                {
                    ...
                    className: 'btn btn-sm btn-outline-primary cetak-detail-pk',
                    init: function(api, node, config) {
                        $(node).removeClass('btn-secondary')
                    }
                }
        ...
        [ 10, 25, 50,'Seluruhnya'],
            ...
            "initComplete": function(settings, json) {
                ...
                processColumnNodes($('#list-part').DataTable());
            }
        });

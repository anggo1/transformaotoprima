        ...
        <div class="content">
                        <div class="card">
                            <div class="modal-content">
                                <div class="card-header card-blue card-outline">
                                    <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Data Penggunaan Barang Per SPK</h3>
                                </div>
                    ...
                    <div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-2">
										<div class="input-group date" id="reservationdate" data-target-input="nearest">
											...
											<input type="text" name="no_spk" id="no_spk" class="form-control" required>

											<div class="input-group-append" data-toggle="datetimepicker">
												<div class="input-group-text"><i class="fa fa-bus"></i>
												</div>
											</div>
										</div>
									</div>
                        ...
                        <div class="form-group row">
									...
									<div class="col-sm-1">
							<button class="btn bg-gradient-primary col-sm-12" onclick="listBody()" type="submit"><span class="fa fa-search"></span> Cari</button>
								</div><div class="col-sm-1">
							<button class="btn bg-gradient-success col-sm-12" onclick="listCetak()" type="submit"><span class="fa fa-print"></span> Cetak</button>
								</div>
						</div>
						</div>
                                    <div id="data-body">
...
<script type="text/javascript">
    ...
    function listBody() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportAccPerbody/listBody'); ?>',
		data: 'date1=' +date1+'&date2=' +date2+'&no_spk=' +no_spk,
			success:
            function(hasil) {
			MyTable.fnDestroy();
			$('#data-body').html(hasil);
			refresh();
			}
		});
	}
	function listCetak() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportAccPerbody/listCetak'); ?>',
		data: 'date1=' +date1+'&date2=' +date2+'&no_spk=' +no_spk,
			success:
            function(hasil) {
			MyTable.fnDestroy();
				$('#modal-cetak').html(hasil);
				$('#cetak-data').modal('show');
			refresh();
			}
		});
	}

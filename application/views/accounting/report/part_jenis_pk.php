        ...
        <div class="content">
                        <div class="card">
                            <div class="modal-content">
                                <div class="card-header card-blue card-outline">
                                    <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Data Penggunaan Barang Per Divisi</h3>
                                </div>
                    ...
                    <div class="card-body">
								...
								<div class="form-group row">
									<label class="col-sm-1 col-form-label">Jenis Pekerjaan</label>
									<div class="col-sm-2">
									<select name="jns_pk" id="jns_pk" class="form-control" required>
...
<script type="text/javascript">
    ...
    function listBody() {
		...
		var jns_pk = document.getElementById("jns_pk").value;
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ReportAccPerpk/listPk'); ?>?date1'+date1+'&date2=' +date2,
		data: 'date1=' +date1+'&date2=' +date2+'&jns_pk=' +jns_pk,
			success:
            function(hasil) {
			MyTable.fnDestroy();

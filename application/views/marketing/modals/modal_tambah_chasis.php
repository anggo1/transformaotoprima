<div class="col-12 col-md-12 col-lg-12">
    <div class="modal-header">
        ...
        <h4 style="display:block; text-align:center;">
            <?php if (!empty($dataChasis)) {
                echo 'Edit Data Chasis';
            } else {
                echo 'Penambahan Data Chasis';
            } ?></h4>
        </p>
    </div>
    <div class="modal-body form">
        <form
            <?php if (empty($dataChasis)) {
                echo 'id="form-tambah-chasis"';
            } else {
                echo 'id="form-update-chasis"';
            } ?>
            method="POST">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4"> <input type="text" name="nama_customer" id="nama_customer"
                                        ...
                                        value="<?php if (!empty($ch->nama_customer)) {

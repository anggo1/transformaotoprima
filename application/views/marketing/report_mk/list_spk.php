                        ...
                        <div class="card">
                            <div class="modal-content">
                                <div class="card-header card-blue card-outline">
                                    <h3 class="card-title"><i class="ion-ios-cog ion-lg text-blue"></i> &nbsp; Daftar SPK</h3>
                                </div>
...
<script type="text/javascript">
    ...
    function listPo() {
		...
		$.ajax({
		type: 'GET',
		url: '<?php echo base_url('ListSpk/listPo'); ?>?date1'+date1+'&date2=' +date2,
...
$(document).on("click", ".delete-po", function() {
	...
	$(document).on("click", ".hapus-po", function() {
		...
		$.ajax({
				method: "POST",
				url: "<?php echo base_url('ListSpk/deletePo'); ?>",
				data: "id=" + id
			})
			.done(function(data) {

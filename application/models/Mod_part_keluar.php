...
class Mod_part_keluar extends CI_Model
{
    ...
    var $column_order = array('a.no_part', 'a.nama_part', 'a.stok', 'a.lokasi', 'a.satuan', 'a.type', 'a.kategori', 'a.kelompok');
    ...
    public function insertGlobal($kode_keluar, $data,$no_part,$nama_part,$qty_keluar,$stok,$stok_a,$stok_p)
        {
            $date = $data['tgl_keluar'];
            $tgl1 = explode('-', $date);
            $tgl_keluar = $tgl1[2] . "-" . $tgl1[1] . "-" . $tgl1[0] . "";
        ...
        if($status_barang=="MPU"){
            ...
            $sql_update = "UPDATE tbl_wh_detail_part_keluar SET status_part ='".$status_barang."', tgl_keluar='".$tgl_keluar."' WHERE id_keluar ='{$id_keluar}'"; $this->db->query($sql_update);
            return $this->db->affected_rows();
        }

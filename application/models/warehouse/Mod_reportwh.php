...
class Mod_reportwh extends CI_Model
{
    ...
    /** End PerKategori */
    //** Report Masuk */
    function cari_masuk($ttmp1 = null, $ttmp2 = null, $status_po = null, $lokasi = null)
    {
        if ($lokasi == 'Cibitung') {
            $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
        a.no_po,a.no_sj_sup,a.no_inv_sup,b.jumlah,sum(b.jumlah * c.hrg_net_cbt) AS total', FALSE);
        }
        if ($lokasi == 'Jakarta') {
            $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
        a.no_po,a.no_sj_sup,a.no_inv_sup,b.jumlah,sum(b.jumlah * c.hrg_net_jkt) AS total', FALSE);
        }
        if ($lokasi == 'Surabaya') {
            $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
        a.no_po,a.no_sj_sup,a.no_inv_sup,b.jumlah,sum(b.jumlah * c.hrg_net_sby) AS total', FALSE);
        }
    ...
    function cari_masuk_status($ttmp1 = null, $ttmp2 = null, $status_po = null, $status = null)
    {
        $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
    ...
    function cari_masuk_npo($ttmp1 = null, $ttmp2 = null, $status_po = null)
    {
        $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
    ...
    function cari_masuk_detail($ttmp1 = null, $ttmp2 = null, $status_po = null)
    {
    ...
    function cari_detail_masuk_po($ttmp1 = null, $ttmp2 = null, $status_po = null)
    {
        $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
        a.no_po,a.no_sj_sup,a.no_inv_sup,b.jumlah,sum(b.jumlah * c.hrg_awal) AS total', FALSE);
        $this->db->from('tbl_wh_part_masuk as a');
    ...
    function cari_detail_masuk_npo($ttmp1 = null, $ttmp2 = null, $status_po = null)
    {
        $this->db->select('a.tgl_masuk,a.kode_masuk,a.id_masuk,a.status_po,b.status_part,a.status,d.nama_sup AS nama_supplier,
        a.no_po,a.no_sj_sup,a.no_inv_sup,b.jumlah,sum(b.jumlah * c.hrg_awal) AS total', FALSE);
        $this->db->from('tbl_wh_part_masuk as a');
    ...
    /** End Perbarang */
    //** Report Keluar */
    function cari_keluar($status_po = null, $ttmp1 = null, $ttmp2 = null)
    {
        if ($status_po == 'N') {
    ...
    function cari_keluar_detail($status_po = null, $ttmp1 = null, $ttmp2 = null)
    {
        if ($status_po == 'N') {
            $query = 'SET @dense_rank = 0;';
            $this->db->query($query);

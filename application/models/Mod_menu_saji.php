...
class Mod_menu_saji extends CI_Model {

    var $table = 'tbl_menu_saji';
    var $column_search = array('menu_nama','menu_deskripsi','menu_harga_lama','menu_harga_baru','menu_kategori_nama'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    var $column_order = array('menu_nama','menu_deskripsi','menu_harga_lama','menu_harga_baru','menu_kategori_nama');
    ...
    {
        $this->db->select('*');
    	//$this->db->get('tbl_menu_saji');
       return $this->db->get('tbl_menu_saji');
    }

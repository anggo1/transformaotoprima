...
class Mod_pegawai extends CI_Model
{
    ...
    var $order = array('a.nip' => 'desc'); // default order 
    ...
    private function _get_datatables_query($term = '')
    {
        ...
        $this->db->join('tbl_hrd_pendidikan as b', 'a.pendidikan=b.id_pendidikan','left');
        $this->db->join('tbl_hrd_jabatan as c', 'a.jabatan=c.id_jabatan','left');
        $this->db->join('tbl_hrd_departement as d', 'a.departement=d.id_departement','left');
        $i = 0;
    ...
    function insertPegawai($tabel, $data)
    {

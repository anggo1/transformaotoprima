...
class ReportWhPerkategori extends MY_Controller
{
    ...
    {
		$data['page'] 		= "Report Per Divisi";
		$data['judul'] 		= "List Kategori";
        $this->load->helper('url');
        $data['menu'] = $this->Mod_menu->getAll()->result();
        $data['dataKategori'] = $this->Mod_reportwhpo->select_kategori();
        //$data['dataSupplier'] = $this->Mod_sparepart->select_supplier();
        $this->template->load('layoutbackend', 'warehouse/report_wh/part_perkategori', $data);
    }
    ...
    public function listKategori() {
        ...
        $kat                 = trim($_GET['kat']);
		$data['dataKategori'] = $this->Mod_reportwhpo->cari_kategori($kat,$ttmp1,$ttmp2); 
        $this->load->view('warehouse/report_wh/data_perkategori', $data);
	}

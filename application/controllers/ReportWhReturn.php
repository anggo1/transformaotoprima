...
class ReportWhReturn extends MY_Controller
{
    ...
    {
		$data['page'] 		= "Report Barang Kembali";
		$data['judul'] 		= "Part Return";
        $this->load->helper('url');
        $data['menu'] = $this->Mod_menu->getAll()->result();
        $this->template->load('layoutbackend', 'warehouse/report_wh/part_return', $data);
    }
    ...
    public function listReturn() {
        ...
        $status 				= $_GET['status'];
		$data['dataBody'] = $this->Mod_reportwhpo->cari_return($status,$ttmp1,$ttmp2); 
        $this->load->view('warehouse/report_wh/data_part_return', $data);
	}

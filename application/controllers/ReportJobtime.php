...
class ReportJobtime extends MY_Controller
{

    public $Mod_report_jobtime;
    public $Mod_menu;
    ...
    {
        parent::__construct();
        $this->load->model(array('service/Mod_report_jobtime', 'Mod_menu'));
    ...
    {
        $data['page']         = "Job Time";
        $data['judul']         = "List Job Time";
        $this->load->helper('url');
        $data['menu'] = $this->Mod_menu->getAll()->result();
        $this->template->load('layoutbackend', 'service/report_service/job_time', $data);
    }

    public function cari_jobtime()
    {
        $date1                 = $_GET['date1'];
        $date2                 = $_GET['date2'];
        $tgl1 = explode('-', $date1);
        ...
        $data['dataJob'] = $this->Mod_report_jobtime->cari_jobtime($ttmp1, $ttmp2);
        $this->load->view('service/report_service/data_job_time', $data);
    }

...
class PartPkOff extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('layoutbackend', 'warehouse/part_pk_off', $data);
    }
    ...
    {
		$id 				= $_GET['id_lapor'];
        $data['dataPk'] = $this->Mod_partpk->select_pk_off($id);
        $this->load->view('warehouse/data_part_pk_off', $data);
    }

...
class ReportWhMasukPerbarang extends MY_Controller
{
    ...
    {
		$data['page'] 		= "Penerimaan Perbarang";
		$data['judul'] 		= "List Barang";
        $this->load->helper('url');
        $data['menu'] = $this->Mod_menu->getAll()->result();
        $this->template->load('layoutbackend', 'warehouse/report_wh/part_masuk_perbarang', $data);
    }
    ...
    public function listPart() {
		...
		$data['dataPart'] = $this->Mod_reportwhpo->cari_part_masuk($no_part,$ttmp1,$ttmp2); 
        $this->load->view('warehouse/report_wh/data_masuk_perbarang', $data);
	}

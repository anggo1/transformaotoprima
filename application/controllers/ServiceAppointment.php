...
public function showPart()
    {
		$sup = $_GET['sup'];
        $data['dataDetail'] = $this->Mod_service_appointment->select_part($sup);
        $this->load->view('warehouse/data_part_with_supplier', $data);
    }
	
	public function cariKode($id)
	{
		$data = $this->Mod_service_appointment->get_part($id);
	...
	public function prosesDetailPo()
	{
		...
		$data['dataPo'] = $this->Mod_service_appointment->insertDetailPo($data);
	...
	public function updateDetailPo()
	{
		...
		$data['dataPo'] = $this->Mod_service_appointment->update_detailPo($id,$jml_part,$hrg_part);

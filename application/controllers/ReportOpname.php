...
class ReportOpname extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('layoutbackend', 'warehouse/report_wh/opname', $data);
    }
    ...
    public function listOpname() {
        ...
        $this->load->view('warehouse/report_wh/data_opname', $data);
	}
    ...
    public function detailOpname()
	{
        ...
        $this->load->view('warehouse/report_wh/data_detail_opname', $data);
	}
    public function cetak_detailOpname()
	{
		...
		echo show_my_print('warehouse/modals/modal_cetak_opname_detail', 'cetak-masuk-detail', $data, ' modal-xl');
	}
    public function cetakListOpname()
	{
		...
		echo show_my_print('warehouse/modals/modal_cetak_opname_list_detail', 'cetak-list-detail', $data, ' modal-xl');
	}
    public function view_detailOpname()
	{
		...
		echo show_my_print('warehouse/modals/modal_cetak_opname_list_view', 'cetak-list-detail', $data, ' modal-xl');
	}

...
class SuratJalan extends MY_Controller
{
	...
	{
		parent::__construct();
		$this->load->model(array('warehouse/Mod_surat_jalan'));
	...
	public function index()
	{
		...
		$data['dataSupplier'] = $this->Mod_surat_jalan->select_supplier();
		$data['dataKode'] = $this->Mod_surat_jalan->select_kode();
		$data['dataKota'] = $this->Mod_surat_jalan->select_kota();
		$this->template->load('layoutbackend', 'warehouse/surat_jalan', $data);
	}
public function showPart()
    {
		$sup = $_GET['sup'];
        $data['dataDetail'] = $this->Mod_surat_jalan->select_part($sup);
	...
	public function ajax_list()
	{
		...
		set_time_limit(3600);
		$list = $this->Mod_surat_jalan->get_datatables();
		$data = array();
		$no = $_POST['start'];
		foreach ($list as $pel) {
			$no++;
		...
		$output = array(
			"draw" => $_POST['draw'],
			"recordsTotal" => $this->Mod_surat_jalan->count_all(),
			"recordsFiltered" => $this->Mod_surat_jalan->count_filtered(),
			"data" => $data,
		);
	...
	{
		$data = $this->Mod_surat_jalan->get_part($id);
	...
	public function prosesDetailPo()
	{
		...
		$data['dataPo'] = $this->Mod_surat_jalan->insertDetailPo($data);
	...
	public function updateDetailPo()
	{
		...
		$data['dataPo'] = $this->Mod_surat_jalan->update_detailPo($id,$jml_part,$hrg_part);
	...
	public function updateBo()
	{
        $id = $_POST['id'];
        $bo = $_POST['bo'];
		$data['dataPo'] = $this->Mod_surat_jalan->update_detailBo($id,$bo);
		//$this->load->view('body_repair/detail_estimasi', $data);
	}
	public function updateRemark()
	{
        $id = $_POST['id'];
        $remark = $_POST['remark'];
		$data['dataPo'] = $this->Mod_surat_jalan->update_remark($id,$remark);
	}
	...
	public function tampilDetail()
	{
		...
		$data['dataDetail'] = $this->Mod_surat_jalan->select_detail($id);
	...
	{
		$id = $_POST['id'];
		$result = $this->Mod_surat_jalan->deleteDetail_po($id);
		if ($result > 0) {
	...
	{
		$id 				= $_POST['id'];
		$data['dataPo'] = $this->Mod_surat_jalan->select_by_id($id);
		$data['detailPo'] = $this->Mod_surat_jalan->select_detail($id);
    ...
    //$nip = $this->input->get( 'nip', TRUE );
		...
		$dataPo= $this->Mod_surat_jalan->select_by_id($id);
		...
		//$id 				= $_POST['id'];
		$detailPo= $this->Mod_surat_jalan->select_detail($id);
